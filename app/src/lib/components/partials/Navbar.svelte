...
<nav class="navbar">
	<a
		href="/"
		class="navbar__link {currentPage === '/' ? 'navbar__link-is-active' : ''}"
		data-sveltekit-replacestate>Accueil</a
	>
	<a
		href="/profil"
		class="navbar__link {currentPage === '/profil' ? 'navbar__link-is-active' : ''}"
		data-sveltekit-replacestate>Profil</a
	>
	<a
		href="/contact"
		class="navbar__link {currentPage === '/contact' ? 'navbar__link-is-active' : ''}"
		data-sveltekit-replacestate>Contact</a
	>
	<div class="navbar__separator" />
	<button
		class="navbar__setting {openSetting ? 'navbar__link-is-active' : ''}"
